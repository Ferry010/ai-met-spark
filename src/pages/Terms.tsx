...
export const Terms = () => (
  <div className="min-h-screen flex flex-col bg-background">
    ...
    <article className="container py-12 max-w-3xl">
      ...
      <p>By using AI Smart Kids you agree to use the app for personal, non-commercial purposes. The €14 individual purchase grants lifetime access for one child account.</p>

    ...
    <header className="sticky top-0 z-30 border-b-2 border-border bg-background/90 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-2 px-4">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <span className="inline-flex items-center gap-1 rounded-full bg-accent-soft px-2.5 py-1.5 font-display text-sm text-accent-dark" title="Dagen op rij">
            <Flame className="h-4 w-4" /> {stats.streak_days}
          </span>
          <span className="hidden items-center gap-1 rounded-full bg-secondary-soft px-2.5 py-1.5 font-display text-sm text-secondary-foreground sm:inline-flex" title="XP">
            <Zap className="h-4 w-4 fill-current" /> {stats.xp}
          </span>
          <span className="inline-flex items-center rounded-full bg-primary-soft px-2.5 py-1.5 font-display text-sm text-primary-dark" title="Level">
            Lv {progress.level}
          </span>

          <DropdownMenu>
            <DropdownMenuTrigger
              className="ml-1 grid h-10 w-10 place-items-center rounded-full bg-primary font-display text-primary-foreground"
              aria-label="Menu"
            >
              {initial}
            </DropdownMenuTrigger>
